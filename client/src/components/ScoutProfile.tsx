    ...
    <div className="scout-card bg-[#EBEBE9] p-8 my-10 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <span className="block text-xs uppercase tracking-wider text-muted-foreground mb-1">Yaş</span>
            <span className="text-lg font-medium">{profile.age}</span>
          </div>
          <div>
            <span className="block text-xs uppercase tracking-wider text-muted-foreground mb-1">Pozisyon</span>
